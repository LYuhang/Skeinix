...
commands such as `/workflow` and `/browser` inject their own persistent context
...
- `/workflow` — activate workflow-building capability. In Chat, workflow editing requires an associated real workflow before any workflow can be modified.
