...
- Command context may be inserted around a user message when the user activates a slash command such as `/build`. The command context describes newly active capabilities and applies until superseded or deactivated by the platform.
"""
