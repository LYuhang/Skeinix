...
AUTH_MFA_ENROLL = "auth.mfa_enroll"
AUTH_MFA_CHALLENGE = "auth.mfa_challenge"
AUTH_MFA_RECOVERY = "auth.mfa_recovery"
...
AUDIT_ACTIONS: frozenset[str] = frozenset({
    ...
    AUTH_MFA_ENROLL, AUTH_MFA_CHALLENGE, AUTH_MFA_RECOVERY, AUTH_MFA_DISABLE,
    ...
    SHARE_GRANT, SHARE_REVOKE, SERVICE_ACCOUNT_CREATE,
