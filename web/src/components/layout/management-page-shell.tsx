...
export function ManagementPageShell({
  ...
  return (
    <div className={cn('page-shell', contained && 'page-shell-contained')}>
...
export function ManagementToolbar({ children, className }: { children: ReactNode; className?: string }) {
  return (
    <div className={cn('flex shrink-0 flex-wrap items-center gap-3 border-y border-edge-subtle bg-surface-sunken/45 px-3 py-2.5', className)}>
      {children}
    </div>
  );
}
